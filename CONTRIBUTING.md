...
- Generally, before developing bugs or enhancements to this charm, you
  should [open an issue](https://github.com/canonical/authentik-worker-operator/issues)
...
# Deploy the charm
juju deploy ./authentik-worker*.charm --resource oci-image=$(yq eval '.resources.oci-image.upstream-source' charmcraft.yaml)
```

## Canonical Contributor Agreement

Canonical welcomes contributions to Charmed Authentik Worker. Please check out
